import{a as ve,b as he,c as ge,d as ye,e as $e,f as G,g as le,i as we,j as xe}from"./chunk.3CQFSM77.js";import"./chunk.7HYUNLOO.js";import{a as ue}from"./chunk.FAPXI6Z7.js";import{a as T,b as j,e as O,f as W,h as J,i as me,j as re,o as oe,p as be,v as fe}from"./chunk.UHXCSBGC.js";import{c as _,g as i,j as a}from"./chunk.7R2OF4PV.js";var ke=2,Fe=new Set(["claude-opus-4-8","claude-sonnet-4-6","claude-opus-4-7","claude-opus-4-6","claude-sonnet-4-5","claude-opus-4-5","claude-opus-4-1"]);function F(e){if(e==null||e==="")return null;let t=Number(e);return Number.isFinite(t)?t:null}function Z(e,t){let n=F(e);return n==null?i("pricing.pending"):`${t==="USD"?"$":"\xA5"}${n.toLocaleString(_(),{maximumFractionDigits:4})}`}function Pe(e){let t=F(e);return t==null?"\u2014":t>=1e6?`${(t/1e6).toLocaleString(_(),{maximumFractionDigits:1})}M`:t>=1e3?`${(t/1e3).toLocaleString(_(),{maximumFractionDigits:0})}K`:t.toLocaleString(_())}function qe(e){return J(e,de,T)||T[e]||e||i("pricing.unknownVendor")}function A(e){let t=qe(e);return t==="Anthropic"?"Claude":t}var de={},se=[];function Ee(){return se}function Le(e){let t=W(e,de,T),n=String(t.seo_slug||"").trim(),o=String(t.seo_intro||"").trim(),l=String(t.icon_url||"").trim();return n&&o&&l?`/brands/${encodeURIComponent(n)}/`:""}function ie(e,t){let n=j(e),o=A(e),l=t||n?.iconUrl||"";return G(l,o,"brand-icon brand-icon--tab")}function X(e){let t=String(e.raw?.lifecycle_status||"").trim().toLowerCase();if(t)return t==="legacy";if(String(e.vendor||"").trim().toLowerCase()!=="anthropic")return!1;let n=String(e.raw?.model_id||e.raw?.id||e.id||"").trim().toLowerCase().replace(/[._]/g,"-");return Fe.has(n)}function ce(e){let t=String(e.raw?.release_date||"").trim();if(!t)return null;let n=Date.parse(t);return Number.isFinite(n)?n:null}var ee={release:{numeric:!0,raw:ce},name:{labelKey:"pricing.th.name",numeric:!1},provider:{labelKey:"pricing.th.provider",numeric:!1},context:{labelKey:"pricing.th.context",numeric:!0,raw:e=>F(e.raw?.context_length)},input:{labelKey:"pricing.th.input",numeric:!0,raw:e=>F(e.raw?.input_price)},output:{labelKey:"pricing.th.output",numeric:!0,raw:e=>F(e.raw?.output_price)}};function De(e,t,n){let o=ee[t];if(!o)return e;let l=[...e];return l.sort((p,u)=>{if(t==="release"){let b=Number(X(p))-Number(X(u));if(b!==0)return b}let v=0;if(o.numeric){let b=o.raw(p),f=o.raw(u);if(b==null||f==null)return b==null&&f==null?0:b==null?1:-1;v=b-f}else t==="name"?v=(p.modelName||"").localeCompare(u.modelName||"",_()):t==="provider"&&(v=A(p.vendor).localeCompare(A(u.vendor),_()));return n==="desc"?-v:v}),l}function Be(e){let t=new Map;for(let n of e){let o=A(n.vendor),l=t.get(o);l||(l={name:o,vendor:n.vendor,icon:n.logoUrl||n.providerIconUrl,models:[]},t.set(o,l)),l.models.push(n)}return[...t.values()]}function Ne(e,t){let n=Number(X(t))-Number(X(e));if(n!==0)return n>0;let o=ce(e),l=ce(t);return o!=null&&l!=null?o>l:o!=null&&l==null}function Ue(e){let t=new Map;for(let n of e){let o=A(n.vendor),l=t.get(o);(!l||Ne(n,l))&&t.set(o,n)}return[...t.values()]}function Ie(e){let t=null;for(let n of e){let o=F(n.raw?.input_price);o==null||o<0||(!t||o<t.value)&&(t={value:o,currency:n.raw?.currency})}return t}function Re(e){let t=Ie(e.models),n=[];if(t){let o=t.currency==="USD"?"$":"\xA5";n.push(i("pricing.group.inputFrom",{symbol:o,price:t.value.toLocaleString(_(),{maximumFractionDigits:4})}))}return n.push(`${e.models.length} ${i("pricing.meta.models")}`),`<span class="plan-table-group-summary">${a(n.join(" \xB7 "))}</span>`}var Me={name:e=>String(e.modelName||"").trim()||"\u2014",provider:e=>A(e.vendor),context:e=>Pe(e.raw?.context_length),input:e=>Z(e.raw?.input_price,e.raw?.currency),output:e=>Z(e.raw?.output_price,e.raw?.currency)};function Se(e){return e==="\u2014"||e===i("pricing.pending")}function Te(e,t){let n=Me[t];return n?String(n(e)||"").trim()||"\u2014":""}function He(e,t){let n=new Map;for(let l of e){let p=Te(l,t);n.set(p,(n.get(p)||0)+1)}let o=new Intl.Collator(_(),{numeric:!0,sensitivity:"base"});return Array.from(n.entries()).map(([l,p])=>({value:l,count:p})).sort((l,p)=>{let u=Se(l.value),v=Se(p.value);return u!==v?u?1:-1:o.compare(l.value,p.value)})}function Ve(e,t,n){return e!==t?'<svg class="model-price-sort-icon model-price-sort-icon--idle" viewBox="0 0 12 12" aria-hidden="true"><path d="M6 2l2.5 3h-5zM6 10l-2.5-3h5z" fill="currentColor"/></svg>':`<svg class="model-price-sort-icon" viewBox="0 0 12 12" aria-hidden="true"><path d="${n==="asc"?"M6 2l3 4H3z":"M6 10L3 6h6z"}" fill="currentColor"/></svg>`}function Ke(e,t,n){let o=ee[e],l=t.column===e&&!!t.value,p=He(n,e);return`<button type="button" class="plan-column-filter-trigger model-price-filter-trigger${l?" is-active":""}" data-model-filter-column="${e}" aria-haspopup="menu" aria-expanded="false" title="${a(i("table.filter.tooltip"))} ${a(i(o.labelKey))}">
    ...
    <div class="plan-column-filter-menu" data-model-filter-menu="${e}" role="menu" hidden>
      ...
      ${p.map(u=>`
        <button type="button" class="plan-column-filter-option${l&&u.value===t.value?" is-active":""}" data-model-filter-value="${a(u.value)}">
          <span class="plan-column-filter-option-label">${a(u.value)}</span>
          <span class="plan-column-filter-option-count">${u.count}</span>
        </button>
      `).join("")}
    </div>`}function je(e,t,n,o){let l=(p,u="")=>{let v=ee[p];return`<th class="model-price-th plan-column-filter ${u}" data-sort-key="${p}" role="columnheader" aria-sort="${p===e?t==="asc"?"ascending":"descending":"none"}" tabindex="0">
    ...
    <td class="model-price-td model-price-td--price">
  ...
  </tr>`}function Ce(e,t,n={}){de=n||{};let o=t.filter(r=>F(r.raw?.input_price)!=null||F(r.raw?.output_price)!=null),l=new Map;for(let r of o){let c=A(r.vendor);l.has(c)||l.set(c,{name:c,icon:r.logoUrl||r.providerIconUrl,vendor:r.vendor})}let p=[...l.values()].sort((r,c)=>r.name.localeCompare(c.name,_())),u="all",v="release",b="desc",f="brand",y="all",L="",x="",P="",$=new Set;function g(){return!!(x&&P&&Me[x])}function k(){return f==="model"?y==="all"?o:o.filter(r=>(r.modelName||"")===y):u==="all"?o:o.filter(r=>A(r.vendor)===u)}function q(){let r=k(),c=L.toLowerCase();return c&&(r=r.filter(d=>String(d.modelName||"").toLowerCase().includes(c)||A(d.vendor).toLowerCase().includes(c))),r}function U(r){let c=r;return g()&&(c=c.filter(d=>Te(d,x)===P)),De(c,v,b)}function M(){return f==="model"?D():B()}function D(){let r=Ue(o).sort((m,S)=>(m.modelName||"").localeCompare(S.modelName||"",_())),c=`<button type="button" class="brand-tab${y==="all"?" is-active":""}" data-model-tab="all">
      <span>${a(i("home.tab.all"))}</span><span class="brand-count">${o.length}</span>
      ...
      <span>${a(i("home.tab.all"))}</span><span class="brand-count">${o.length}</span>
    </button>`,c=p.map(d=>{let m=o.filter(S=>A(S.vendor)===d.name).length;return`<button type="button" class="brand-tab${u===d.name?" is-active":""}" data-provider="${a(d.name)}">
        ${ie(d.vendor,d.icon)}
        <span>${a(d.name)}</span>
  ...
  `}function nt(e,t,n){let o=e.querySelector("#plansExportTrigger"),l=e.querySelector("#plansExportMenu");if(!o||!l)return;let p=()=>{l.hidden=!0,o.setAttribute("aria-expanded","false")};o.addEventListener("click",()=>{let u=l.hidden;l.hidden=!u,o.setAttribute("aria-expanded",String(u))}),document.addEventListener("click",u=>{e.querySelector("#plansExport")?.contains(u.target)||p()}),document.addEventListener("keydown",u=>{u.key==="Escape"&&p()}),l.addEventListener("click",async u=>{let v=u.target.closest("[data-export-format]");if(!v)return;p();let b=v.dataset.exportFormat,f=t(),y=await import("./chunk.2XPGR2KF.js");if(f.kind==="models"){b==="excel"?y.exportModelPricesExcel(f.models):b==="word"?y.exportModelPricesWord(f.models):b==="pdf"&&y.exportModelPricesPdf(f.models);return}b==="excel"?y.exportPlansExcel(f.plans,n):b==="word"?y.exportPlansWord(f.plans,n):b==="pdf"&&y.exportPlansPdf(f.plans,n)})}function at(e,t={},n=[],o=[]){if(!w.codingPlanOverview)return;let l=be(e,t,T),p=Ye(l,t),u=[...p.values()].sort((s,h)=>s.sortOrder-h.sortOrder),v=Qe(l,n,t),b=[...v.values()].sort((s,h)=>s.sortOrder-h.sortOrder||s.label.localeCompare(h.label,"zh-CN")),f={all:l.length,free:oe(l).length},y=Xe(l),L=`
            ...
            <span class="workbench-stat"><strong>${l.length}</strong> ${a(i("home.meta.records"))}</span>
            <span class="workbench-stat"><strong>${u.length}</strong> ${a(i("home.meta.brands"))}</span>
            <span class="workbench-stat"><strong>${b.length}</strong> ${a(i("home.meta.models"))}</span>`;w.codingPlanOverview.innerHTML=`
  ...
  `,Ae();let x=w.codingPlanOverview.querySelector(".plans-workbench"),P=w.codingPlanOverview.querySelector("#brandFilterBar"),$=w.codingPlanOverview.querySelector("#brandTabs"),g=w.codingPlanOverview.querySelector("#modelTabs"),k=w.codingPlanOverview.querySelector("#brandDetail");et(x),Oe(k);let q=w.codingPlanOverview.querySelector("#planAdvisorFab"),U=we({plans:l,providerInfo:t,modelCatalog:n,fab:q});U&&location.hash==="#advisor"&&U.open();let M=l;nt(w.codingPlanOverview,()=>({kind:B==="pricing"?"models":"plans",plans:ye(M),models:Ee()}),t);let D="all",B="brand",V="",I=new Set,z=P.querySelector("[data-plan-available-toggle]"),te=()=>{if(!z)return;let s=ve();z.classList.toggle("is-active",s),z.setAttribute("aria-pressed",String(s))},H=()=>{if(te(),B==="pricing"){Ce(k,o,t);return}k.innerHTML=le(M,V,t,I,D!=="all")},C=()=>{ge(),V="",I.clear()},Y=()=>{I.clear(),H()};$e(k,()=>M,Y,s=>{V=V===s?"":s,H()});let K=s=>{I.has(s)?I.delete(s):I.add(s),H()};k.addEventListener("click",s=>{if(s.target.closest("a"))return;let h=s.target.closest("[data-plan-group-toggle]");h&&K(h.dataset.planGroupToggle)}),k.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;let h=s.target.closest("[data-plan-group-toggle]");!h||h.tagName==="BUTTON"||s.target.closest("a")||(s.preventDefault(),K(h.dataset.planGroupToggle))});let Q=()=>{[$,g].forEach(s=>{s.querySelectorAll(".brand-tab").forEach(h=>h.classList.remove("is-active"))})},r=s=>{s==="all"?M=l:s==="free"?M=oe(l):p.has(s)?M=p.get(s).plans:v.has(s)&&(M=v.get(s).plans)},c=s=>{let h=w.codingPlanOverview.querySelector("#codingPlanTitle"),N=w.codingPlanOverview.querySelector("#workbenchSummary"),E=w.codingPlanOverview.querySelector("#workbenchStats");if(h&&(h.textContent=i(s==="pricing"?"pricing.title":"home.title")),N&&(N.textContent=i(s==="pricing"?"pricing.summary":"home.summary")),!!E)if(s==="pricing"){let R=o.filter(We),ae=new Set(R.map(pe=>T[pe.vendor]||pe.vendor)).size;E.innerHTML=`<span><strong>${R.length}</strong> ${a(i("pricing.meta.models"))}</span><span><strong>${ae}</strong> ${a(i("pricing.meta.vendors"))}</span>`}else E.innerHTML=L},d=s=>{s!==B&&(B=s,P.querySelectorAll("[data-dimension]").forEach(h=>{h.classList.toggle("is-active",h.dataset.dimension===s)}),$.hidden=s!=="brand",g.hidden=s!=="model",m&&(m.placeholder=i(s==="brand"?"home.search.brand":"home.search.model")),C(),D="all",M=l,Q(),s==="pricing"?P.hidden=!0:(P.hidden=!1,(s==="brand"?$:g).querySelector('[data-brand="all"]')?.classList.add("is-active")),q&&(q.hidden=s==="pricing"),m&&(m.value=""),S(),c(s),rt(s),H())},m=w.codingPlanOverview.querySelector("#brandSearchInput"),S=()=>{let s=(m?.value||"").trim().toLowerCase(),h=B==="brand"?$:g;h.querySelectorAll(".brand-tab[data-brand]").forEach(E=>{let R=E.dataset.brand;if(R==="all"||R==="free"){E.hidden=!1;return}let ae=(E.dataset.brandLabel||"").toLowerCase();E.hidden=s?!ae.includes(s):!1});let N=h.querySelector(".brand-divider");N&&(N.hidden=!1)};m?.addEventListener("input",S),P.addEventListener("click",s=>{if(s.target.closest("[data-plan-available-toggle]")){he(),Y();return}let N=s.target.closest("[data-dimension]");if(N){d(N.dataset.dimension);return}let E=s.target.closest(".brand-tab");if(!E||!$.contains(E)&&!g.contains(E))return;let R=E.dataset.brand;C(),D=R,Q(),E.classList.add("is-active"),r(R),H()}),((globalThis.location?.pathname||"").replace(/\/+$/,"")||"/")==="/model"&&d("pricing")}function rt(e){if(typeof globalThis.history?.replaceState=="function")try{let t=new URL(globalThis.location.href),n=e==="pricing"?"/model":"/";globalThis.history.replaceState(null,"",`${n}${t.search}${t.hash}`)}catch{}}function ot(e){if(!w.codingPlanOverview)return;let t=e==="backend"?i("home.dataUnavailable.backend"):i("home.dataUnavailable.static");w.codingPlanOverview.innerHTML=`
    <section class="plans-workbench" aria-labelledby="codingPlanTitle">
      <div class="workbench-head">
        <div>
  ...
  `,Ae()}async function lt(){ue();let e=await xe();if(e.dataUnavailable){ot(e.source);return}at(e.plans,e.providerInfo||{},e.modelCatalog||[],e.models||[])}lt();
