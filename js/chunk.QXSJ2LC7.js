import{a as De,b as Ne}from"./chunk.7HYUNLOO.js";import{A as K,B as V,C as Me,D as Ue,E as ie,a as x,b as ke,c as _e,d as we,e as D,f as ee,g as B,h as T,i as te,j as Pe,k as re,l as ne,m as H,n as j,p as Se,q as Ae,r as Le,s as M,t as ae,u as se,w as Te,x as N,y as E,z as Ce}from"./chunk.UHXCSBGC.js";import{a as w,c as _,e as R,f as $e,g as i,j as s,k as I}from"./chunk.7R2OF4PV.js";var pt=new Set(["\u5F85\u66F4\u65B0","\u5F85\u786E\u8BA4","\u8BF7\u4EE5\u5B98\u7F51\u4E3A\u51C6"]);function O(e){let t=String(e??"").trim();return t&&!pt.has(t)?t:"\u2014"}function F(e="",t=""){let n=String(t??"").trim();return{column:n?String(e??"").trim():"",value:n}}function le(e){return!!(e?.column&&e?.value)}function Ee(e,t,n){return le(t)?e.filter(r=>n(r,t.column)===t.value):e}var oe={};function Fe(e){oe=e||{}}function ft(e){let t=B(e,oe,x);return t.training?i(`privacy.training.${t.training}`)||t.training:i("privacy.filter.notResearched")}var qe={token:"billing.token",credits:"billing.credits",five_hours:"billing.requests",weekly:"billing.requests",monthly:"billing.requests"};function ce(e){let t=qe[e.limitType];return t?i(t):i("billing.undisclosed")}function Re(e){return!!qe[e.limitType]}var ue=[{key:"provider",labelKey:"table.col.provider",value:e=>T(e.provider,oe,x)||"\u2014"},{key:"name",labelKey:"table.col.name",value:e=>H(e.name)||"\u2014"},{key:"monthlyPrice",labelKey:"table.col.monthly",value:e=>O(e.monthlyPrice)},{key:"quarterlyPrice",labelKey:"table.col.quarterly",value:e=>O(e.quarterlyPrice)},{key:"annualPrice",labelKey:"table.col.annual",value:e=>O(e.annualPrice)},{key:"billingUnit",labelKey:"table.col.billingUnit",value:e=>ce(e)},{key:"quota",labelKey:"table.col.quota",value:e=>N(e)?.text||"\u2014"},{key:"unitPrice",labelKey:"table.col.unitPrice",value:e=>E(e)?.text||"\u2014"},{key:"model",labelKey:"table.col.model",value:e=>j(e)||"\u2014"},{key:"status",labelKey:"table.col.status",value:e=>H(e.statusLabel)||"\u2014"},{key:"domesticPayment",labelKey:"table.col.domesticPayment",value:e=>e.domesticPayment?i("common.supported"):"\u2014"},{key:"intlNetwork",labelKey:"table.col.intlNetwork",value:e=>e.intlNetwork?i("common.required"):"\u2014"},{key:"dataTraining",labelKey:"table.col.dataTraining",value:e=>ft(e)},{key:"verifiedAt",labelKey:"table.col.verified",value:e=>H(e.lastVerifiedAt)||i("table.verified.pending")},{key:"source",labelKey:"table.col.source",value:e=>e.url?i("table.source.name"):"\u2014"}],P=F(),U=!1,mt=new Intl.Collator(_(),{numeric:!0,sensitivity:"base"});function yt(e){return e.status==="available"||e.status==="rush_sale"||e.statusLabel==="\u53EF\u7528"||e.statusLabel==="\u53EF\u8D2D\u4E70"}function Ie(){return U}function yr(){U=!U}function de(e){return ue.find(t=>t.key===e)}function Be(e,t){let n=de(t);return n?String(n.value(e)||"").trim()||"\u2014":""}function bt(){P=F(),U=!1}function z(){return le(P)&&!!de(P.column)}function He(e){let t=e;return U&&(t=t.filter(yt)),z()&&(t=Ee(t,P,Be)),t}function je(e,t){return U?`
  ...
  `:""}function vt(e,t){let n=new Map;for(let r of e){let a=Be(r,t.key);n.set(a,(n.get(a)||0)+1)}return Array.from(n.entries()).map(([r,a])=>({value:r,count:a})).sort((r,a)=>r.value==="\u2014"&&a.value!=="\u2014"?1:a.value==="\u2014"&&r.value!=="\u2014"?-1:mt.compare(r.value,a.value))}function Ke(e,t){let n=P.column===e.key&&!!P.value,r=vt(t,e);return`
  ...
  `}function Ve(e,t){if(!z())return"";let n=de(P.column);return`
      ...
      <div class="plan-card-head">
        <div class="plan-card-title-row flex items-start justify-between gap-2">
          ...
          <div class="plan-card-meta flex shrink-0 flex-col items-end gap-1.5">
            <span class="whitespace-nowrap rounded-md px-2 py-0.5 text-xs font-medium ${a}">${ze(e)}</span>
            ${n}
  ...
  `}function Ct(e,t,n,r,a){return e.length?Ge(e,n).map(o=>{let l=a||r.has(o.provider),p=(l?o.plans:o.plans.slice(0,Y)).map(y=>{let f=re(y),v=f===t,h=y.confidenceScore,$="trust-dot--yellow";h&&h>=.8?$="trust-dot--high":h&&h<.5&&($="trust-dot--red");let A=[y.domesticPayment?`<span class="plan-card-badge">${s(i("badge.domesticPayment"))}</span>`:"",ae(y)?`<span class="plan-card-badge plan-card-badge--intl" title="${s(i("badge.intl.title"))}">${s(String(y.monthlyCurrency||"USD").toUpperCase())}</span>`:""].filter(Boolean).join(""),X=`<span class="trust-dot ${$}" title="${s(i("trust.label"))}: ${h!=null?Math.round(h*100)+"%":i("common.unknown")}"></span>`;return`
      ...
      <section class="plan-card-group">
        ...
        ${m}
      </section>`}).join(""):""}function Oe(e,t,n,r,a=Y){let o=n?e.plans:e.plans.slice(0,a);return o.length?o.map(l=>{let d=re(l),p=d===t,u=Ye(l),m=Me(l),b=M(l.monthlyPrice)?`<div>${s(l.monthlyPrice)}</div>${m?`<div class="plan-table-price-first">${s(i("table.price.firstMonth"))} ${s(m)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',y=M(l.quarterlyPrice)?`<div>${s(l.quarterlyPrice)}</div>${M(l.quarterlyMonthlyPrice)?`<div class="plan-table-price-sub">${s(i("table.price.approx"))} ${s(l.quarterlyMonthlyPrice)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',f=M(l.annualPrice)?`<div>${s(l.annualPrice)}</div>${M(l.annualMonthlyPrice)?`<div class="plan-table-price-sub">${s(i("table.price.approx"))} ${s(l.annualMonthlyPrice)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',v=N(l),h=v?`<span class="text-slate-700 dark:text-slate-300" title="${s(v.full)}">${s(v.text)}</span>`:'<span class="text-slate-400">\u2014</span>',$=Re(l)?`<span class="billing-unit-badge billing-unit-badge--${s(l.limitType||"undisclosed")}">${s(ce(l))}</span>`:'<span class="text-slate-400">\u2014</span>',A=E(l),X=A?`<span class="whitespace-nowrap font-medium text-brand-700 dark:text-brand-300"${A.estimated?` title="${s(i("table.unitPrice.estimated"))}"`:""}>${s(A.text)}</span>`:'<span class="text-slate-400">\u2014</span>',C=se(l.lastVerifiedAt),nt=C.state==="fresh"?`<span class="text-xs font-medium text-emerald-600 dark:text-emerald-400" title="${s(i("verified.freshTitle",{date:C.date}))}">${s(C.days===0?i("verified.tableToday"):i("verified.tableDaysAgo",{n:C.days}))}</span>`:C.state==="stale"?`<span class="text-xs font-medium text-amber-600 dark:text-amber-400" title="${s(i("verified.staleTitle",{date:C.date}))}">${s(i("verified.stale"))}</span>`:`<span class="text-xs text-slate-400">${s(i("table.verified.pending"))}</span>`,be=I(l.url),ve=V(l,be),at=be?`<a href="${s(ve.href)}" target="_blank" rel="${ve.rel}" ${K(l)} class="text-sm font-medium text-brand-600 hover:text-brand-800 dark:text-brand-400 dark:hover:text-brand-300">${s(i("table.source.site"))}</a>`:'<span class="text-slate-400">\u2014</span>',st=l.domesticPayment?`<span class="rounded-md bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-300">${s(i("common.supported"))}</span>`:`<span class="text-slate-400">${s(i("common.notSupported"))}</span>`,it=l.intlNetwork?`<span class="rounded-md bg-orange-100 px-2 py-0.5 text-xs font-medium text-orange-700 dark:bg-orange-900/30 dark:text-orange-300">${s(i("common.required"))}</span>`:`<span class="text-slate-400">${s(i("common.notSupported"))}</span>`,lt=Lt(l,r),ot=p?`<tr class="plan-detail-row">
          <td colspan="15" class="plan-inline-detail-cell">
            ${ie(l,r)}
          </td>
        </tr>`:"",ge=$t(l,r),he=s(l.name),ct=ae(l)?` <span class="plan-intl-tag" title="${s(i("badge.intl.title"))}">${s(String(l.monthlyCurrency||"USD").toUpperCase())}</span>`:"",ut=(ge?`<a href="${s(ge)}" class="font-medium text-brand-700 hover:text-brand-900 hover:underline dark:text-brand-300 dark:hover:text-brand-200">${he}</a>`:he)+ct,xe=`${q(e.iconUrl,e.label,"brand-icon brand-icon--table")}<span>${s(e.label)}</span>`,dt=e.brandHref?`<a href="${s(e.brandHref)}" class="plan-provider-cell plan-provider-cell--link">${xe}</a>`:`<div class="plan-provider-cell">${xe}</div>`;return`
      <tr class="plan-select-row${p?" is-selected":""}" data-plan-key="${s(d)}" tabindex="0" aria-selected="${p?"true":"false"}">
        <td class="px-3 py-3 font-medium text-slate-900 dark:text-white">${dt}</td>
        <td class="break-words px-3 py-3 text-slate-900 dark:text-white">${ut}</td>
        ...
        <td class="plan-table-nowrap px-3 py-3"><span class="rounded-md px-2 py-0.5 text-xs font-medium ${u}">${ze(l)}</span></td>
      ...
      ${ot}`}).join(""):""}function Mt(e,t,n,r,a,o){let l=t.length?Ge(t,r).map(d=>{if(d.plans.length===1)return Oe(d,n,!0,r);let p=!o&&d.plans.length>Y,u=o||!p||a.has(d.provider),m=At(d),b=`${q(d.iconUrl,d.label,"brand-icon brand-icon--section")}
    ...
    </div>`}function Pr(e,t="",n={},r=new Set,a=!1){if(!e.length)return`<p class="text-sm text-slate-500 dark:text-slate-400">${s(i("table.empty.none"))}</p>`;let o=Se(e,n,x);if(!o.length)return`<p class="text-sm text-slate-500 dark:text-slate-400">${s(i("table.empty.none"))}</p>`;Fe(n);let l=He(o),d=a||z()||Ie();return`
    <div>
      ${je(l,o)}
      ${Ve(l,o)}
    ...
    </div>`}var Ze=7.2,fe=[{id:"light",labelKey:"advisor.usage.light",value:500},{id:"medium",labelKey:"advisor.usage.medium",value:3e3},{id:"heavy",labelKey:"advisor.usage.heavy",value:1e4},{id:"extreme",labelKey:"advisor.usage.extreme",value:3e4}],Ut={Anthropic:"Claude",Claude:"Claude",ChatGPT:"GPT",ChartGPT:"GPT",Google:"Gemini","Google Antigravity":"Gemini",Grok:"Grok","Z.ai":"GLM",BytePlus:"Doubao",\u963F\u91CC\u4E91:"Qwen","Alibaba Cloud":"Qwen",StepFun:"Step",\u9636\u8DC3\u661F\u8FB0:"Step",\u5FEB\u624BStreamLake:"KAT-Coder","Kwai StreamLake":"KAT-Coder",StreamLake:"KAT-Coder",Cursor:"Cursor",Qoder:"Qoder",Trae:"Trae",OpenCode:"OpenCode"},Qe=8;function pe(e){let t=String(e||"").trim();if(!t||/未指定|无明确|未公开|不适用|待更新|待确认|pending|unspecified|not specified|n\/a|tbd|unknown|see official/i.test(t))return null;let n=t.replace(/,/g,"").match(/(\d+(?:\.\d+)?)\s*(万)?/);if(!n)return null;let r=parseFloat(n[1])*(n[2]==="\u4E07"?1e4:1);return Number.isFinite(r)&&r>0?r:null}function Dt(e){let t=pe(e.monthlyRequests);if(t!=null)return{value:t,estimated:/约|估算|approx|estimat/i.test(e.monthlyRequests),basis:"monthly"};let n=pe(e.weeklyRequests);if(n!=null)return{value:Math.round(n*4.3),estimated:!0,basis:"weekly"};let r=pe(e.fiveHoursRequests);return r!=null?{value:r*30,estimated:!0,basis:"fiveHours"}:null}function Nt(e){let t=[{value:e.monthlyPriceValue,cycle:"monthly"},{value:e.quarterlyMonthlyPriceValue,cycle:"quarterly"},{value:e.annualMonthlyPriceValue,cycle:"annual"}].filter(a=>Number.isFinite(a.value)&&a.value>=0);if(!t.length)return null;let n=t.reduce((a,o)=>o.value<a.value?o:a),r=e.monthlyCurrency==="CNY";return{value:n.value,cycle:n.cycle,currency:e.monthlyCurrency||"USD",usd:r?n.value/Ze:n.value}}function Et(e,t={}){let n=Ut[e.provider];return n||T(e.provider,t,x)||e.provider||"Other"}function Ft(e,t,n={}){let r=new Map;for(let l of e)l.id&&r.set(l.id,Et(l,n));let a=new Map;for(let l of t){let d=new Set((l.modelIds||[]).map(p=>r.get(p)).filter(Boolean));for(let p of d)a.set(p,(a.get(p)||0)+1)}return{options:[...a.entries()].map(([l,d])=>({family:l,count:d})).sort((l,d)=>d.count-l.count||l.family.localeCompare(d.family,"en")),familyByModelId:r}}function qt(e,t){return new Set((e.modelIds||[]).map(n=>t.get(n)).filter(Boolean))}function Rt(e,t,n){let{families:r,usage:a,budget:o}=t,l=[],d=0;for(let p of e){if(p.planType==="api_package"){d+=1;continue}let u=Nt(p);if(o!=null&&u&&u.usd>o)continue;let m=!1;if(r.size){let v=qt(p,n);if(!v.size)m=!0;else if(![...v].some(h=>r.has(h)))continue}let b=Dt(p),y=b&&u&&b.value>0?u.usd/b.value*1e3:null,f;m?f=4:b?b.value>=a?f=1:f=2:f=3,l.push({plan:p,price:u,quota:b,costPer1k:y,tier:f})}return l.sort((p,u)=>{if(p.tier!==u.tier)return p.tier-u.tier;if((p.tier===1||p.tier===2)&&p.costPer1k!==u.costPer1k)return(p.costPer1k??1/0)-(u.costPer1k??1/0);let m=p.price?p.price.usd:1/0,b=u.price?u.price.usd:1/0;return m-b}),{results:l,paygoCount:d}}function We(e){return Math.round(e).toLocaleString(_())}function Je(e,t="USD"){return`${t==="CNY"?"\xA5":"$"}${e.toLocaleString(_(),{maximumFractionDigits:e<10?2:0})}`}function It(e,t){let{plan:n,price:r,quota:a,costPer1k:o,tier:l}=e,d=T(n.provider,t,x),p=[];if(l===1?p.push(`<span class="plan-advisor-chip plan-advisor-chip--good">${s(i("advisor.chip.enough"))}</span>`):l===2?p.push(`<span class="plan-advisor-chip plan-advisor-chip--warn">${s(i("advisor.chip.short"))}</span>`):l===3?p.push(`<span class="plan-advisor-chip plan-advisor-chip--muted">${s(i("advisor.chip.unknown"))}</span>`):p.push(`<span class="plan-advisor-chip plan-advisor-chip--muted">${s(i("advisor.chip.unlabeled"))}</span>`),a){let f=w()==="en"?" (":"\uFF08",v=w()==="en"?")":"\uFF09",h=a.estimated?`${f}${s(i("advisor.chip.estimated",{basis:i(`advisor.basis.${a.basis}`)}))}${v}`:"";p.push(`<span class="plan-advisor-chip">${s(i("advisor.chip.monthlyQuota",{n:We(a.value)}))}${h}</span>`)}if(o!=null&&p.push(`<span class="plan-advisor-chip">${s(i("advisor.chip.per1k",{price:Je(o)}))}</span>`),n.supportedModelNames?.length){let f=n.supportedModelNames.slice(0,3).join(" / "),v=n.supportedModelNames.length>3?" \u2026":"";p.push(`<span class="plan-advisor-chip">${s(i("advisor.chip.supports",{models:f+v}))}</span>`)}let u=`<span class="plan-advisor-price-muted">${s(i("advisor.price.official"))}</span>`;if(r){let f=r.cycle!=="monthly"?`<span class="plan-advisor-cycle">${s(i(`advisor.cycle.${r.cycle}`))}</span>`:"",v=r.currency==="CNY"?`<span class="plan-advisor-price-note">${s(i("advisor.price.cnyNote",{n:We(r.usd),rate:Ze}))}</span>`:"";u=`<span class="plan-advisor-price">${Je(r.value,r.currency)}/${s(i("common.perMonth"))}</span>${f}${v}`}let m=I(n.url),b=m?V(n,m):null,y=b?`<a href="${s(b.href)}" target="_blank" rel="${b.rel}" ${K(n)} class="plan-advisor-link">${s(i("advisor.link"))}</a>`:"";return`
  ...
  `}function Bt(e,t){let n=fe.some(r=>r.value===t.usage)?"":t.usage;return`
    <div class="plan-advisor-form">
      ...
      <div class="plan-advisor-field">
        ...
        <div class="plan-advisor-options" data-advisor-usage>
          ${fe.map(r=>{let a=r.value===t.usage;return`
