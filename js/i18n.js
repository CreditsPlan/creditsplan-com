...
export const translations = {
  ...
  'reports.col.date': { en: 'Date', zh: '日期' },
  'reports.col.plan': { en: 'Plan', zh: '套餐' },
  'reports.col.field': { en: 'Price field', zh: '价格档位' },
  'reports.col.price': { en: 'Price', zh: '价格' },
  'reports.col.change': { en: 'Change', zh: '变动' },
  ...
  'changelog.filter.kindLabel': { en: 'Filter by type', zh: '类型筛选' },
  'changelog.filter.kind.all': { en: 'All updates', zh: '全部更新' },
  'changelog.filter.kind.data': { en: 'Data update', zh: '数据更新' },
  'changelog.filter.kind.feature': { en: 'Site feature', zh: '站点功能' },
  'changelog.filter.kind.catalog': { en: 'Plans & brands', zh: '套餐与品牌' },
  'changelog.filter.dateLabel': { en: 'Time range', zh: '时间范围' },
  'changelog.filter.date.all': { en: 'All time', zh: '全部时间' },
  'changelog.filter.date.1m': { en: 'Last month', zh: '最近一月' },
  'changelog.filter.date.3m': { en: 'Last 3 months', zh: '最近三月' },
  'changelog.filter.date.6m': { en: 'Last 6 months', zh: '最近半年' },
  'changelog.filter.date.year': { en: 'This year', zh: '今年' },
  'changelog.filter.resultCount': { en: 'Showing {n} / {total} entries', zh: '显示 {n} / {total} 条记录' },
  'changelog.filter.filteredDesc': { en: 'Filtered · {n} entries', zh: '已筛选 · 共 {n} 条' },
  'changelog.filter.defaultDesc': { en: 'Sorted by publish date, newest first', zh: '按发布日期由近到远排列' },
  'changelog.filter.emptyTitle': { en: 'No matching entries', zh: '无匹配记录' },
  'changelog.filter.emptyBody': { en: 'No entries match the current filters. Try adjusting the filter criteria.', zh: '当前筛选条件下没有更新记录，请尝试调整筛选范围。' },
  ...
  'changelog.view.all': { en: 'All updates', zh: '全部更新' },
  'changelog.view.roadmap': { en: 'In progress', zh: '正在推进' },
  'changelog.sidebar.brand': { en: 'Changelog', zh: '更新日志' },
  'changelog.filter.label': { en: 'Filter by category', zh: '分类筛选' },
  'changelog.cat.all': { en: 'All categories', zh: '全部分类' },
  'changelog.date.label': { en: 'Filter by date', zh: '日期筛选' },
  'changelog.date.all': { en: 'All dates', zh: '全部日期' },
  'changelog.filter.result': { en: 'Showing {shown} / {total} entries', zh: '显示 {shown} / 共 {total} 条' },
  'changelog.search.placeholder': { en: 'Search title or summary...', zh: '搜索标题 / 摘要...' },
  'changelog.search.aria': { en: 'Search changelog titles and summaries', zh: '搜索更新日志标题和摘要' },
  'changelog.empty.roadmap.title': { en: 'Nothing planned yet', zh: '暂无规划中的功能' },
  'changelog.empty.roadmap.body': { en: 'Feature plans sourced from user feedback appear here once added.', zh: '功能规划来自用户反馈，加入后会显示在这里。' },
  ...
  'seo.pcAllPlans': { en: 'All plans', zh: '全部套餐' },
  'seo.pcMatchCount': { en: '{n} matching events', zh: '共 {n} 条匹配' },
